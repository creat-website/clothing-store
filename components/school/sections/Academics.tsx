export default function Academics() {
  return (
    <section id="academics" className="py-12 border-t border-zinc-200 dark:border-zinc-800 scroll-mt-24">
      <h2 className="text-xl sm:text-2xl font-semibold">Academics</h2>
      <div className="mt-6 grid sm:grid-cols-2 gap-6 text-sm">
        <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/60 dark:bg-zinc-900/50 backdrop-blur p-5 shadow-sm hover:shadow-md transition">
